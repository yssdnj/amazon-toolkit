...
# 工具清单（按编号注册）
TOOLS = {
    "1": ("产品周数据清洗（领星 产品表现-MSKU）", "amazon_toolkit.tools.weekly_report_source"),
    "2": ("周报数据 增量一周", "amazon_toolkit.tools.add_new_line"),
    "3": ("Excel 行复制 N 次", "amazon_toolkit.tools.excel_row_repeat"),
    "4": ("ASIN图片重命名", "amazon_toolkit.tools.pic_rename"),
